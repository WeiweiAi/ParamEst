...
save_fig = {'save_fig': True, 'fig_format': 'tif', 'file_path': path_, 'filename': 'NKE_pump_BG_6states_fit2'}
...
filename_BG_volt = path_+'NKE_pump_BG_6states_fit2_volt_ss.csv'
filename_BG_Nai = path_+'NKE_pump_BG_6states_fit2_Nai_ss.csv'
filename_BG_Ke = path_+'NKE_pump_BG_6states_fit2_Ke_ss.csv'
filename_BG_ATP = path_+'NKE_pump_BG_6states_fit2_ATP_ss.csv'
