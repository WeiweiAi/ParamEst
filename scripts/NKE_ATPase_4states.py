...
def referenceModel_volt():
    # Convert the model to CellML 2.0 if needed
    model_name='New_Terkildsen_NaK_BG_Fig5'
    path_='../models/'
    sedFilename = model_name+'_V2.sedml' 
    ...
    for i in range(len(model_ids_)):
        ...
        simSetting={'type':'UniformTimeCourse','algorithm':dict_algorithm,'initialTime':0,'outputStartTime':0,'outputEndTime':190,'numberOfSteps':1900}
...
def BG4Statemodel_volt():
    ...
    for i in range(len(model_ids_)):
        ...
        changes={'q_mem':{'component':'main','name':'q_mem','newValue':str(q_mem)},
                 'c_Nai':{'component':'main','name':'c_Nai','newValue':'50'},
                 'c_Nae':{'component':'main','name':'c_Nae','newValue':'150'},
                 'c_Ki':{'component':'main','name':'c_Ki','newValue':small_value},
                 'c_Ke':{'component':'main','name':'c_Ke','newValue':'5.4'},
                 'c_P_i':{'component':'main','name':'c_P_i','newValue':small_value},
                 'c_MgATP':{'component':'main','name':'c_MgATP','newValue':'10'},
                 'c_MgADP':{'component':'main','name':'c_MgADP','newValue':small_value},
                 'T':{'component':'main','name':'T','newValue':'310'},
                 'pH':{'component':'main','name':'pH','newValue':'7.4'},
                 }  
        # the format is {'id':{'component':str,'name':str,'newValue':str}}
        # Example: changes={'V_m':{'component':'main','name':'V_m','newValue':'-0.055'}
        ...
        # name is the variable name of the outputs
        # scale is the scaling factor for the output variable
        outputs={'t':{'component':'main','name':'t','scale':1},
                 'v_1':{'component':'main','name':'v_1','scale':1},
                 'v_NKE':{'component':'main','name':'v_NKE','scale':1},         
                 'u_e':{'component':'main','name':'u_e','scale':1e3},
                 'c_Nai':{'component':'main','name':'c_Nai','scale':1},
                 'c_Ke':{'component':'main','name':'c_Ke','scale':1},
                 'c_MgATP':{'component':'main','name':'c_MgATP','scale':1},
                 }
        # You can add more outputs if needed
...
def BG4Statemodel_Nai():
    ...
    for i in range(len(model_ids_)):
        ...
        model_source = model_path + model_name + '.cellml' 
        # This is to modify the model parameters if needed
        changes={'q_mem':{'component':'main','name':'q_mem','newValue':'0'},
                 'c_Nai':{'component':'main','name':'c_Nai','newValue':Nai[i]},
                 'c_Nae':{'component':'main','name':'c_Nae','newValue':small_value}, # 0
                 'c_Ki':{'component':'main','name':'c_Ki','newValue':'80'},
                 'c_Ke':{'component':'main','name':'c_Ke','newValue':'15'},
                 'c_P_i':{'component':'main','name':'c_P_i','newValue':'1'},
                 'c_MgATP':{'component':'main','name':'c_MgATP','newValue':'2'},
                 'c_MgADP':{'component':'main','name':'c_MgADP','newValue':small_value}, # 0
                 'T':{'component':'main','name':'T','newValue':'308'},
                 'pH':{'component':'main','name':'pH','newValue':'7.2'},
                 }  
        # the format is {'id':{'component':str,'name':str,'newValue':str}}
        # Example: changes={'V_m':{'component':'main','name':'V_m','newValue':'-0.055'}
...
def BG4Statemodel_Ke():
    ...
    for i in range(len(model_ids_)):
        ...
        changes={'q_mem':{'component':'main','name':'q_mem','newValue':'0'},
                 'c_Nai':{'component':'main','name':'c_Nai','newValue':'50'},
                 'c_Nae':{'component':'main','name':'c_Nae','newValue':'150'},
                 'c_Ki':{'component':'main','name':'c_Ki','newValue':'140'},
                 'c_Ke':{'component':'main','name':'c_Ke','newValue':Ke[i]},
                 'c_P_i':{'component':'main','name':'c_P_i','newValue':'0.5'},
                 'c_MgATP':{'component':'main','name':'c_MgATP','newValue':'10'},
                 'c_MgADP':{'component':'main','name':'c_MgADP','newValue':'0.02'},
                 'T':{'component':'main','name':'T','newValue':'310'},
                 'pH':{'component':'main','name':'pH','newValue':'7.4'},
                 }  
        # the format is {'id':{'component':str,'name':str,'newValue':str}}
...
def BG4Statemodel_ATP():
    ...
    for i in range(len(model_ids_)):
        ...
        # This is to modify the model parameters if needed
        changes={'q_mem':{'component':'main','name':'q_mem','newValue':'0'},
                 'c_Nai':{'component':'main','name':'c_Nai','newValue':'40'},
                 'c_Nae':{'component':'main','name':'c_Nae','newValue':small_value}, # 0
                 'c_Ki':{'component':'main','name':'c_Ki','newValue':small_value}, # 0
                 'c_Ke':{'component':'main','name':'c_Ke','newValue':'5'},
                 'c_P_i':{'component':'main','name':'c_P_i','newValue':'0.005'}, # 0
                 'c_MgATP':{'component':'main','name':'c_MgATP','newValue':ATP[i]},
                 'c_MgADP':{'component':'main','name':'c_MgADP','newValue':small_value}, # 0
                 'T':{'component':'main','name':'T','newValue':'297'},
                 'pH':{'component':'main','name':'pH','newValue':'7.4'},
                 }  
        # the format is {'id':{'component':str,'name':str,'newValue':str}}
        # Example: changes={'V_m':{'component':'main','name':'V_m','newValue':'-0.055'}
