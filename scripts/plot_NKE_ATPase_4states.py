...
save_fig = {'save_fig': True, 'fig_format': 'tif', 'file_path': path_, 'filename': 'fit_NKE_ATPase'}
...
filename_BG_volt = path_+'NKE_pump_BG_4states_volt_ss.csv'
filename_BG_Nai = path_+'NKE_pump_BG_4states_Nai_ss.csv'
filename_BG_Ke = path_+'NKE_pump_BG_4states_Ke_ss.csv'
filename_BG_ATP = path_+'NKE_pump_BG_4states_ATP_ss.csv'
...
line_cfg[2] = { 'xdata': (filename_BG_volt,'u_e'), 'ydata':(filename_BG_volt,'v_1'),
                'color': 'r', 'linestyle': '--',  'label': '4 state model'}
...
line_cfg[4] = { 'xdata': (filename_BG_Nai,'c_Nai'), 'ydata':(filename_BG_Nai,'v_1'),
                'color': 'r', 'linestyle': '--',  'label': '4 state model'}
line_cfg[5] = { 'xdata': (filename_Ke,'environment | Ke (mM)'), 'ydata':(filename_Ke,'environment | v_cyc_nak (per_second)'),
                'color': 'k', 'linestyle': '-',  'label': '15 state ss model'}
line_cfg[6] = { 'xdata': (filename_BG_Ke,'c_Ke'), 'ydata':(filename_BG_Ke,'v_1'),
                'color': 'r', 'linestyle': '--',  'label': '4 state model'}
line_cfg[7] = { 'xdata': (filename_ATP,'environment | MgATP (mM)'), 'ydata':(filename_ATP,'environment | v_cyc_nak (per_second)'),
                'color': 'k', 'linestyle': '-',  'label': '15 state ss model'}
line_cfg[8] = { 'xdata': (filename_BG_ATP,'c_MgATP'), 'ydata':(filename_BG_ATP,'v_1'),
                'color': 'r', 'linestyle': '--',  'label': '4 state model'}
line_cfg[9] = { 'xdata': (filename_BG_volt,'u_e'), 'ydata':(filename_BG_volt,'v_NKE'),
                'color': 'b', 'linestyle': '--',  'label': '4 state ss model'}
line_cfg[10] = { 'xdata': (filename_BG_Nai,'c_Nai'), 'ydata':(filename_BG_Nai,'v_NKE'),
                'color': 'b', 'linestyle': '--',  'label': '4 state ss model'}
line_cfg[11] = { 'xdata': (filename_BG_Ke,'c_Ke'), 'ydata':(filename_BG_Ke,'v_NKE'),
                'color': 'b', 'linestyle': '--',  'label': '4 state ss model'}
line_cfg[12] = { 'xdata': (filename_BG_ATP,'c_MgATP'), 'ydata':(filename_BG_ATP,'v_NKE'),
                'color': 'b', 'linestyle': '--',  'label': '4 state ss model'}


plot_cfg[1] = {'ylabel': 'cycle rate', 'xlabel': 'potential (mV)','show_grid': 'both', 'grid_axis': 'both',  'title_y': -0.3,
                'line': [1,2,9], 'legend': [1,2,9]}
plot_cfg[2] = {'ylabel': 'cycle rate', 'xlabel': 'Na_i (mM)','show_grid': 'both', 'grid_axis': 'both',   'title_y': -0.3,
                'line': [3,4,10], 'legend': [3,4,10]}
plot_cfg[3] = {'ylabel': 'cycle rate', 'xlabel': 'K_e (mM)','show_grid': 'both', 'grid_axis': 'both',  'title_y': -0.3,
                'line': [5,6,11], 'legend': [5,6,11]}
plot_cfg[4] = {'ylabel': 'cycle rate', 'xlabel': 'ATP (mM)','show_grid': 'both', 'grid_axis': 'both', 'title_y': -0.3,
                'line': [7,8,12], 'legend': [7,8,12]}
