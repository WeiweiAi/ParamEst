...
def pe_task():
    ...
    path_='../models/'
    model_path ='./'
    model_name='NKE_pump_BG_6states'
   ...
   # time={dataSourceId_0:{'column_name':'t','startIndex':101,'endIndex':None,'component':'main','name':'t'}} 
    ...
    obs1=[dataSourceId_1,'v_ss',None,None,'environment','v_R1',1]
    dataSourceId_2='v_ss_Ke'
    obs2=[dataSourceId_2,'v_ss',None,None,'environment','v_R1',1]
    dataSourceId_3='v_ss_ATP'
    obs3=[dataSourceId_3,'v_ss',None,None,'environment','v_R1',1]
    dataSourceId_4='v_ss_volt'
    obs4=[dataSourceId_4,'v_ss',None,None,'environment','v_R1',1]
    ...
    exp1=[dataSourceId_cond,'c_Nai',None,None,None,'environment','c_Nai']
    dataSourceId_cond2='c_Nae'
    exp2=[dataSourceId_cond2,'c_Nae',None,None,None,'environment','c_Nae']
    dataSourceId_cond3='c_Ki'
    exp3=[dataSourceId_cond3,'c_Ki',None,None,None,'environment','c_Ki']
    dataSourceId_cond4='c_Ke'
    exp4=[dataSourceId_cond4,'c_Ke',None,None,None,'environment','c_Ke']
    dataSourceId_cond5='c_P_i'
    exp5=[dataSourceId_cond5,'c_P_i',None,None,None,'environment','c_P_i']
    dataSourceId_cond6='c_MgATP'
    exp6=[dataSourceId_cond6,'c_MgATP',None,None,None,'environment','c_MgATP']
    dataSourceId_cond7='c_MgADP'
    exp7=[dataSourceId_cond7,'c_MgADP',None,None,None,'environment','c_MgADP']
    dataSourceId_cond8='T'
    exp8=[dataSourceId_cond8,'T',None,None,None,'environment','T']
    dataSourceId_cond9='q_mem'
    exp9=[dataSourceId_cond9,'q_mem',None,None,None,'environment','q_mem']
    dataSourceId_cond10='pH'
    exp10=[dataSourceId_cond10,'pH',None,None,None,'environment','pH']
    ...
    parameterId_1='K_1'
    adjustable1=[parameterId_1,'environment','K_1',1,1e8,1000,'linear',[fitId_1,fitId_2,fitId_3,fitId_4]]
    parameterId_2='K_3'
    adjustable2=[parameterId_2,'environment','K_3',1,1e3,157,'linear',[fitId_1,fitId_2,fitId_3,fitId_4]]
    parameterId_3='K_6'
    adjustable3=[parameterId_3,'environment','K_6',1,1e3,92,'linear',[fitId_1,fitId_2,fitId_3,fitId_4]]
    parameterId_4='K_7'
    adjustable4=[parameterId_4,'environment','K_7',1,1e4,4000,'linear',[fitId_1,fitId_2,fitId_3,fitId_4]]
    parameterId_5='kappa_3'
    adjustable5=[parameterId_5,'environment','kappa_3',1e2,1e6,2e5,'linear',[fitId_1,fitId_2,fitId_3,fitId_4]]
    parameterId_6='kappa_6'
    adjustable6=[parameterId_6,'environment','kappa_6',1,1e3,10,'linear',[fitId_1,fitId_2,fitId_3,fitId_4]]
    parameterId_7='K_13'
    adjustable7=[parameterId_7,'environment','K_13',1e-2,1e2,1,'linear',[fitId_1,fitId_2,fitId_3,fitId_4]]
    parameterId_8='kappa_1'
    adjustable8=[parameterId_8,'environment','kappa_1',1,1e3,300,'linear',[fitId_1,fitId_2,fitId_3,fitId_4]]

    parameterId_9='K_14'
    adjustable9=[parameterId_9,'environment','K_14',1,1e3,100,'linear',[fitId_1,fitId_2,fitId_3,fitId_4]]

    parameterId_10='kappa_13'
    adjustable10=[parameterId_10,'environment','kappa_13',1,1e4,500,'linear',[fitId_1,fitId_2,fitId_3,fitId_4]]
    parameterId_11='kappa_15'
    adjustable11=[parameterId_11,'environment','kappa_15',1e-3,1,1e-2,'linear',[fitId_1,fitId_2,fitId_3,fitId_4]]

    adjustables=[adjustable1,adjustable2,adjustable3,adjustable4,adjustable5,adjustable6,adjustable7,adjustable8,adjustable9,adjustable10,adjustable11]
