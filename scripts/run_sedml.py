...
#sedFiles=['NKE_pump_BG_4states_Nai_V2.sedml','NKE_pump_BG_4states_Ke_V2.sedml','NKE_pump_BG_4states_ATP_V2.sedml','NKE_pump_BG_4states_volt_V2.sedml']
#sedFiles=['NKE_pump_BG_4states_pe.sedml']
sedFiles=['NKE_pump_BG_6states_pe.sedml']
